...
import Having_fun from "../components/Having_fun";
import Proposing from "../components/Proposing";
import Lovers_talking from "../components/Lovers_talking";
  ...
  return (
    <HomeLayout>
      <motion.div className="flex flex-col items-center justify-center w-full h-full">
        ...
        <motion.button
          className="px-3 py-2 mt-8 border-2 border-white shadow-xs lg:text-md hover:shadow-sm hover:shadow-white shadow-white/50"
